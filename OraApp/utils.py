...
def send_pwd_reset_email(user, role, name,app_password):
    token = user.get_reset_token() 

    subject = 'Password Reset'
    sender = ('OraJobs', 'udn992110@gmail.com')
    ...
    html = render_template('email.html', link=link, name=name, img=img, resend=resend,app_password=app_password)
